...
CREATE TABLE IF NOT EXISTS `members` (
  ...
  PRIMARY KEY  (`sn`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 PACK_KEYS=1 CHECKSUM=1 AUTO_INCREMENT=38 ;
...
CREATE TABLE IF NOT EXISTS `papers` (
  ...
  PRIMARY KEY  (`serial`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 PACK_KEYS=1 CHECKSUM=1 AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `register` (
  ...
  PRIMARY KEY  (`serial`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 PACK_KEYS=0 AUTO_INCREMENT=15 ;
...
CREATE TABLE IF NOT EXISTS `session` (
  `session_id` varchar(85) NOT NULL default '',
  `passwd` varchar(85) NOT NULL default '',
  `category` varchar(85) NOT NULL default '',
  `abbr` varchar(85) NOT NULL default '',
  `session_name` varchar(85) NOT NULL default '',
  `session_email` varchar(85) NOT NULL default ''
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `session` VALUES ('ILT2018_esd', 'nxgunou7', '5', 'ESD', '白能勝', 'pai@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_iee', 'j37slefeg', '1', 'IEE', '陳鴻誠', 'hcchen@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_ics', 'ig6mnxdh', '2', 'ICS', '卜文正', 'puo@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_sia', 'ybjhfiiui', '12', 'SIA', '林熊徵', 'hclin@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_3c', 'bjtz23g0m', '4', '3C', '陳啟鈞', 'chichun@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_ctd', 'yue51d7zb', '6', 'CTD', '曾振東', 'jdtseng@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_icd', 'eulytipx', '3', 'ICD', '謝韶徽', 'ssh@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_oth', '0wsm0bw6p', '13', 'OTH', '董秋溝', 'tungck@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_mdc', 'vh35ovm9', '8', 'MDC', '陳宏光', 'hankchentw@gmail.com');
INSERT INTO `session` VALUES ('ILT2018_hcd', '87rqsjrd', '9', 'HCD', '王圳木', 'cmwang@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_ntd', 'hcvun66e4', '7', 'NTD', '陳瑞茂', 'raymond@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_cit', '19r8c95u2', '11', 'CIT', '林灶生', 'jslin@ncut.edu.tw');
INSERT INTO `session` VALUES ('ILT2018_isa', 'p8qpe8w', '10', 'MSA', '林基源', 'chiyuan@ncut.edu.tw');
