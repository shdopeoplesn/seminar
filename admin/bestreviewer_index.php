...
while(list($sn,$name,$typenumber) = mysql_fetch_row($list))
{
   ...
   //計算評審人數
   $stra="select count(sn) from bestreviewer where suid='$sn' ";
...
?>
		<tr>
			...
			<td class=content width="36"><a href="bestreviewer_setup.php?numbers_sn=<?php=$sn?>"><img border="0" src="edit.gif" width="12" height="12"></a></td>
		</tr>
<?php
}
?>
