...
<table border="1" width="100%" bordercolorlight="#000000" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td align="center">最佳論文編號</td>
		<td align="center">最佳論文中文名稱</td>
		<td align="center">最佳論文英文名稱</td>
	</tr>
<?php
...
$i=1;
$str="select papernumber,papername,paperchinesename from  papers where  category='$category' and bestpaper ='1' order by papernumber ";
$list =mysql_query($str,$link);
