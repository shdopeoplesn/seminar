...
?>
		<tr>
			<td width="70" class=content><?php=$total?></td>
			<td width="70" class=content><?php=$id?></td>
		    <td width="70" class=content><?php=$money?></td>
			<td width="70" class=content><?php=$matriculate?></td>
	        <td class=content width="150"><?php=$idchange?></td> 
			<td class=content width="150"><?php=$atmchk?></td>
			<td class=content width="150"><?php=$summoney?></td>
			<td class=content width="150"><?php=$pay?></td> 			
		</tr>
<?php
}
}
