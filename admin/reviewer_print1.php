...
//驗證評審權限
$str = "select paperman,papername,category,number,propose1,chktime1,chkstate1,reviewer_sn1 from my_papers where serial='$serial'";
$list = mysql_query($str,$link);
list($paperman,$papername,$category,$number,$propose1,$chktime1,$chkstate1,$reviewer_sn1) = mysql_fetch_row($list);

if( $reviewer_sn1 != $numbers_sn )
{
  echo "很抱歉，這不屬於您的範圍哦！";
  exit;
}
...
<div align="center">
	<table border="0" width="650" cellspacing="0" cellpadding="0">
		<tr>
			<td height="40" width="650" colspan="2"><p align="center"><span style="font-size: 16pt">第十屆智慧生活科技研討會(ILT2015)</span></td>
		</tr>
		<tr>
			<td height="40" width="650" colspan="2"><font size="4">論文名稱：<?php=$papername?></font></td>
		</tr>
		<tr>
			<td height="40" width="650" colspan="2"><font size="4">論文編號：<?php=$typenumber.$number?></font></td>
		</tr>
		<tr>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
  ...
  12.0pt;font-family:新細明體'><o:p><?php=$propose1?></o:p></span></p>
  </td>
 </tr>
</table>
...
?>
		...
		<tr>
			...
			<td height="35" width="548">掃描成.pdf或者.jpg Email至：<?php=$type_email?></td>
		</tr>
		<tr>
			<td height="35" width="102" align="right">(2)</td>
			<td height="35" width="548">傳真：( 04 ) 2391-7426</td>
		</tr>
		<tr>
			<td height="35" width="102" align="right">(3)</td>
			<td height="35" width="548">411台中市太平區中山路一段215巷35號<br>
			國立勤益技術學院&nbsp; 資訊工程系 收(請註明ILT2011研討會文件)</td>
		</tr>
		<tr>
			<td height="40" width="650" colspan="2">　</td>
		</tr>
