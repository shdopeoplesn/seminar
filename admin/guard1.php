...
<table border="0" width="728" id="table1" cellspacing="0">
	<tr>
		<td align="right"><font color="#002EB7">開車人數：<?php=$disscuss_count?>人</font></td>
	</tr>
</table>
</div>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  <td valign=top style='width:80px;border:1.0pt solid windowtext;
  ...
  <p class=MsoNormal><o:p><span lang=EN-US></span>姓名</o:p></p>
  </td>
  <td valign=top style='border-right:1.0pt solid windowtext; border-top:1.0pt solid windowtext; border-bottom:1.0pt solid windowtext; width:211px;border-left:medium none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  ...
  <td valign=top style='border-right:1.0pt solid windowtext; border-top:1.0pt solid windowtext; border-bottom:1.0pt solid windowtext; width:130pt;border-left:medium none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;padding-left:5.4pt; padding-right:5.4pt; padding-top:0cm; padding-bottom:0cm' align="center">
...
$str = "select name,unit,career,tel,plate from on_line where traffic ='自行開車' order by uint";
$list = mysql_query($str,$link);
while(list($name,$unit,$career,$tel,$plate) = mysql_fetch_row($list))
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes'>
  ...
  <p class=MsoNormal><span lang=EN-US><o:p>".$name."</o:p></span></p>
  </td>
