...
//驗證評審權限
$gg=0;
$str = "select papername,reviewer_sn1,chkstate1 from my_papers where serial='$serial'";
$list = mysql_query($str,$link);
list($papername,$reviewer_sn1,$paper_chkstate1) = mysql_fetch_row($list);
...
<?php
$str = "select serial,papername,paperman,category,number,papernumber,chkstate1,propose1 from my_papers where serial='$serial'";
$list = mysql_query($str,$link);
list($serial,$papername,$paperman,$category,$number,$papernumber,$chkstate1,$propose1) = mysql_fetch_row($list);
 ...
 //-----------------------審查狀態----------------
      $strk = "select name from chkstate where sn='$chkstate1'";
      $listk = mysql_query($strk,$link);
      list($chkstate) = mysql_fetch_row($listk);
?>

<form action="examine_update1.php" method="post" name="Regist" onsubmit="return formcheck();">
<div align="center">
<table>
 <tr>
 ...
 <tr>
    ...
    <td class=content><textarea name=propose cols="30" rows="10"><?php=$propose1?></textarea></td>
 </tr>
 <tr>
