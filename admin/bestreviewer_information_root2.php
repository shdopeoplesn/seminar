...
<div align="center">
	<table border="0" width="720" cellspacing="1" cellpadding="0">
		<tr>
			<td colspan="7" class=title>最佳論文_領域：<?php=$category?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php=$abbr?></td>
		</tr>
		<tr>
...
<?php
   $stra="select id,passwd,name,email,paperno1,paperno2,paperno3,paperno4,paperno5,paperno6,paperno7,paperno8,paperno9,paperno10,paperno11,paperno12,paperno13,paperno14,paperno15,reply from bestreviewer where id like '$abbr%' order by id";
