...
$result=mysql_query("Select * from bestreviewer where id like '$abbr%'");
...
$str = "insert into bestreviewer(id,passwd,name,sever,email,chk_number,best_id,bank_name,bank_id,address) 
values('$reviewer_id','$randkey','$name','$sever','$email','$randkey2','$best_id','$bank_name','$bank_id','$address')";
...
$mail_title="懇請".$name."教授/先生 擔任ILT2018的邀請擔任".$category."的BEST_PAPER_REVIEWER";
$mail_content="懇請".$name."教授/先生 擔任ILT2018邀請擔任".$category."的BEST_PAPER_REVIEWER，基本資料如下：<br>
帳號：".$reviewer_id."<br>
密碼：".$randkey."<br>
============================================================<br>
審稿者網址：http://ilt2018.ncut.edu.tw/bestreview/login.php<br>
若需要更改資訊請登入本研討會網站即可

";

$url="ilt2018.ncut.edu.tw/bestreview/reply.php?key=".$randkey2;
...
header("location:happy.php?act=bestreviewer_add");
