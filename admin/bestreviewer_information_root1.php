...
<div align="center">
	<table border="0" width="562" cellspacing="1" cellpadding="0">
		<tr>
			<td colspan="6" class=title>領域：<?php=$category?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php=$abbr?></td>
		</tr>
		<tr>
...
<?php
   $stra="select name,id,passwd,email,paperno1,paperno2,paperno3,paperno4,paperno5,paperno6,paperno7,paperno8,paperno9,paperno10,paperno11,paperno12,paperno13,paperno14,paperno15 from bestreviewer where id like '$abbr%' ";
...
?>
		<tr>
			<td width="144" class=content><?php=$name?></td>
			<td width="125" class=content><?php=$id?></td>
			<td width="125" class=content><?php=$passwd?></td>
            <td width="125" class=content><?php=$email?></td>
			<td width="79"  class=content><?php=$total?></td>
		</tr>
<?php
   }
?>
